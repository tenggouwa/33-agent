  ...
  <div class="home-wrap">
    <div class="login-block" v-if="loginTab===0">
      <div class="contain">
        ...
        <div class="login-line">
          ...
          <input class="input" type="text" v-model="regParam.email" :placeholder="tipWord">
        </div>
        <div class="yanz-line">
        ...
        <div class="login-line">
          ...
          <input class="input" type="text" v-model="regParam.password" placeholder="请输入您的密码">
        </div>
        <div class="tip-line">
    ...
    <div class="login-block" v-if="loginTab===1">
      <div class="contain">
        ...
        <div class="tip-line">
          <span class="cursor" @click="loginTab=2">忘记密码？</span>
          <div class="switch-box">
    ...
    <div class="login-block" v-if="loginTab===2">
      <div class="contain">
        ...
        <div v-if="operateType=='mobile'">
          ...
          <div class="login-line">
            <span><i class="iconfont icon-mima"></i></span>
            <input class="input" type="text" v-model="setParam.password" placeholder="请输入您的新密码">
          </div>
          <div class="login-line">
            <span><i class="iconfont icon-mima"></i></span>
            <input class="input" type="text" v-model="setParam.password2" placeholder="请再次输入您的新密码">
          </div>
        </div>
